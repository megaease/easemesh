//go:generate go run github.com/megaease/easemeshctl/cmd/transformer Service.Observability ServiceObservabilityTracings=tracing ObservabilityMetrics=metric ObservabilityOutputServer=outputserver
/*
